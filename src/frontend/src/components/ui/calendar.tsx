  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button:
          "h-9 w-9 rounded-md border-0 p-0 font-normal hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring aria-selected:opacity-100",
