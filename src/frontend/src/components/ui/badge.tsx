  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-secondary text-secondary-foreground dark:border-sky-900/60 dark:bg-sky-950/40 dark:text-sky-100",
        outline:
          "text-foreground dark:border-sky-900/60 dark:bg-slate-950/30 dark:text-sky-100",
