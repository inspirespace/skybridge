...
- Milestone 2: Infra-as-code baseline (in progress).
  ...
  - Status:
    - Terraform baseline under `infra/terraform/` + GitHub Actions fmt check added, API Gateway → Lambda routes wired to handler zip.
...
- Milestone 4: Public beta readiness (in progress).
  ...
  - Status:
    - added `docs/backend-runbook.md`, `docs/backend-maintenance.md`, `docs/backend-release-readiness.md`.
